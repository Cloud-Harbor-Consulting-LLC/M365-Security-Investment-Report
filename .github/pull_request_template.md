...
- [ ] `Invoke-ScriptAnalyzer -Path ./src, ./tests, ./scripts -Recurse -Severity Warning, Error`
      is clean. **All three paths** — CI checks more than `./src`.
...
- [ ] Nothing unavailable now renders as `0`, `$0`, or a blank. It says so, and says why.
...
<!-- Genuinely useful. Reviewers would rather know where you were unsure than guess. -->
